...
public class DetallesPedidoHistorial extends javax.swing.JPanel {
  ...
  public DetallesPedidoHistorial(Conexion con, Pedido pedido) {
    initComponents();
  ...
  private void btnVolverMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolverMousePressed
    HistorialVista pv = new HistorialVista(con);
    pv.setSize(780, 530);
    pv.setLocation(0, 0);
    
    escritorio.removeAll();
    escritorio.add(pv, BorderLayout.CENTER);
